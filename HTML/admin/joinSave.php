...
<body class="gray">
                ...
                <form action="joinResult.php" name="joinResult" method="post" onsubmit="return joinChecks()">
                    <fieldset>
                        ...
                        <div>
                            ...
                            <input type="text" id="youBirth" name="youBirth" placeholder="YYYY-MM-DD" class="inputStyle" maxlength="10">
    ...
    <script>
        ...
        function joinChecks(){
            ...
            // 비밀번호확인 유효성 검사
            if($("#youPassC").val() == ''){
                $("#youPassCComment").text("* 비밀번호를 다시한번 입력해주세요.");
                $("#youPassC").focus();
                return false;
            };

            // 비밀번호 동일한지 체크
            if($("#youPacc").val() == $("#youPassC").val()){
            ...
            if(!getYouPhone.test($("#YouPhone").val())){
                $("#YouPhoneComment").text("* 휴대폰 번호 형식이 일치하지 않습니다.(000-0000-0000)");
                $("#YouPhone").val('');
                $("#YouPhone").focus();
                return false;
            };
