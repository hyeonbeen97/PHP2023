...
<body class="gray">
    ...
    <main id="main" class="container">
        <div class="login__inner">
            <h2>로그인</h2>
            <p>로그인을 하시면 게시글 열람 및 작성이 가능합니다.<br>회원가입을 하시면 로그인이 가능합니다.<br>admin@admin.com / 1234</p>
            ...
            <div class="login__footer">
                <ul class="listStyle">
                    <li>회원이 아니시라면 회원가입을 먼저 해주세요 ! <a href="join.html">회원가입</a></li>
                    <li>아이디가 기억이 나지 않으신다면 ? <a href="#">아이디찾기</a></li>
                    <li>비밀번호가 기억이 나지 않으신다면 ? <a href="#">비밀번호 찾기</a></li>
                </ul>
            </div>
        </div>
    </main>
