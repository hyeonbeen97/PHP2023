    ...
    <main id="main" class="container">
        <div class="intro__inner center container bmStyle">
            <picture class="intro__images">
                <source srcset="../PHP/assets/img/join01.png, ../assets/img/join01@2x.png 2x, ../assets/img/join01@3x.png 3x" />
                <img src="../PHP/assets/img/join01.png" alt="회원가입 이미지">
            </picture>
            <p class="intro__text">
        ...
        <div class="join__inner container">
            ...
            <div class="join__agree">
                ...
                <div>
                    <p class = "agreeMsg"></p>
                    <a href="joinSave.php"><button href="#" class="btnstyle10 agreeBtn">동의</button></a>
                </div>
    </main>
    <!-- //main -->
